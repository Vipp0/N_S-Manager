...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "dash.recent_joins": {"it": "Ultimi ingressi", "en": "Latest joins"},
    "dash.no_joins": {"it": "Nessun ingresso con data registrata.", "en": "No joins with a recorded date."},
    "dash.anniversaries": {"it": "Anniversari in gilda", "en": "Guild anniversaries"},
    "dash.no_anniversaries": {"it": "Nessun anniversario nei prossimi 30 giorni.", "en": "No anniversaries in the next 30 days."},
    "dash.anniversary_line": {"it": "{date}  {name} — {years} {unit}", "en": "{date}  {name} — {years} {unit}"},
    "dash.year_one": {"it": "anno", "en": "year"},
    "dash.year_many": {"it": "anni", "en": "years"},
    "dash.top_nations": {"it": "Top 5 nazioni (membri attuali)", "en": "Top 5 nations (current members)"},
    ...
    "dash.yesterday": {"it": "Ieri", "en": "Yesterday"},
    ...
    "label.name_history": {"it": "Storico nomi", "en": "Name history"},
    "label.family_name_field": {"it": "Family Name", "en": "Family Name"},
    "label.old_name": {"it": "Nome precedente", "en": "Previous name"},
    "label.new_name": {"it": "Nuovo nome", "en": "New name"},
    ...
    "name_history.add": {"it": "Aggiungi cambio", "en": "Add change"},
    "name_history.delete": {"it": "Elimina", "en": "Delete"},
    ...
    "update.available.body_install": {
        "it": "È disponibile la versione {version}. Vuoi installarla adesso?\n\nPrima di aggiornare viene fatta una copia di sicurezza del database, poi il programma si riavvia da solo.",
        "en": "Version {version} is available. Do you want to install it now?\n\nA safety copy of the database is made first, then the program restarts by itself.",
    },
    "update.available.install": {"it": "Installa ora", "en": "Install now"},
    "update.window.title": {"it": "Aggiornamento in corso...", "en": "Updating..."},
    "update.step.download": {"it": "Scaricamento della versione {version}...", "en": "Downloading version {version}..."},
    "update.step.extract": {"it": "Preparazione dei file...", "en": "Preparing the files..."},
    "update.step.wait": {"it": "Chiusura del programma...", "en": "Closing the program..."},
    "update.step.backup": {"it": "Salvataggio della versione attuale...", "en": "Saving the current version..."},
    "update.step.install": {"it": "Installazione della nuova versione...", "en": "Installing the new version..."},
    "update.step.restart": {"it": "Riavvio...", "en": "Restarting..."},
    "update.failed.title": {"it": "Aggiornamento non riuscito", "en": "Update failed"},
    "update.failed.body": {
        "it": "Non è stato possibile aggiornare ({error}). Il programma è rimasto com'era: puoi scaricare la versione dalla pagina.",
        "en": "The update could not be completed ({error}). The program is unchanged: you can download the version from the page.",
    },
    "update.apply_failed.body": {
        "it": "Non è stato possibile completare l'aggiornamento ({error}). È stata ripristinata la versione precedente.",
        "en": "The update could not be completed ({error}). The previous version has been restored.",
    },
    ...
    "timer.daily_reset": {"it": "Reset giornaliero", "en": "Daily reset"},
    "timer.weekly_reset": {"it": "Reset settimanale", "en": "Weekly reset"},
    "timer.imperial_delivery": {"it": "Consegna imperiale", "en": "Imperial delivery"},
    "timer.trade_reset": {"it": "Reset commercio", "en": "Trade reset"},
    "timer.barter_reset": {"it": "Reset baratto", "en": "Barter reset"},
    "timer.blackshrine_reset": {"it": "Reset Black Shrine", "en": "Black Shrine reset"},
    "timer.cycle_day": {"it": "Giorno, poi notte tra {time}", "en": "Day, night in {time}"},
    "timer.cycle_night": {"it": "Notte, poi giorno tra {time}", "en": "Night, day in {time}"},
    "timer.cycle_label": {"it": "Ciclo giorno/notte", "en": "Day/night cycle"},
    "bdo.reset_title": {"it": "Reset e cicli", "en": "Resets and cycles"},
    "bdo.boss_title": {"it": "Prossimi boss", "en": "Next bosses"},
    ...
    "dash.divider": {"it": "Informazioni generali", "en": "General information"},
    "server.error.not_found": {"it": "Non trovato", "en": "Not found"},
    "settings.bdo_guild_label": {"it": "Nome della gilda in gioco (per il confronto)", "en": "In-game guild name (for the comparison)"},
    "settings.bdo_guild_placeholder": {"it": "Nome esatto della gilda", "en": "Exact guild name"},
    "bdo.guild_title": {"it": "Confronto con la gilda in gioco", "en": "In-game guild comparison"},
    "bdo.guild_no_name": {
        "it": "Imposta il nome della gilda in Impostazioni → Server BDO per attivare il confronto.",
        "en": "Set the guild name in Settings → BDO servers to enable the comparison.",
    },
    "bdo.guild_summary": {
        "it": "{name}: {count} membri in gioco. Guild Master: {master}.",
        "en": "{name}: {count} members in game. Guild Master: {master}.",
    },
    "bdo.guild_all_match": {"it": "Nessuna differenza con i Membri attuali.", "en": "No differences with the current members."},
    "bdo.guild_not_in_app": {"it": "In gioco ma non nel programma ({n}):", "en": "In game but not in the program ({n}):"},
    "bdo.guild_ex_banned": {"it": "In gioco ma registrati come ex/bannati ({n}):", "en": "In game but recorded as former/banned ({n}):"},
    "bdo.guild_not_in_game": {"it": "Membri attuali non trovati in gioco ({n}):", "en": "Current members not found in game ({n}):"},
    "bdo.guild_hint": {
        "it": "Solo un confronto tra i nomi: il programma non modifica nulla da solo. I dati arrivano da un servizio esterno e possono avere qualche ora di ritardo.",
        "en": "A name comparison only: the program changes nothing by itself. Data comes from an external service and may be a few hours behind.",
    },
    ...
    "bdo.profile.energy": {"it": "Energia", "en": "Energy"},
    "bdo.profile.created": {"it": "Famiglia creata il", "en": "Family created"},
    "bdo.profile.private_note": {
        "it": "Profilo privato: alcuni dati potrebbero mancare o essere non aggiornati.",
        "en": "Private profile: some data may be missing or out of date.",
    },
